...
if __name__ == "__main__":
    ...
    latitude = float(input("Enter any latitude of the country you want to do in all_states_code.py (if necessary, use country-gps-location.py for this):: "))
    longitude = float(input("Enter any longitude of the country you want to do in all_states_code.py (if necessary, use country-gps-location.py for this):: "))

    nearest_location, distance, populated, state_locations = find_nearest_location(locations, latitude, longitude)
    if nearest_location:
        loc_lat, loc_lon, country, state, region, region_code, region_ori, road, city = nearest_location
        ...
        if region_code.lower() == "a":
            ...
            print("Lake/Water landing strip:", city)
